...
const getAll = async () => {
  const result = await axios
    .get("http://localhost:4000/api/v1/contacts/", {
...
const post = async (data) => {
  ...
  const result = await axios
    .post(`http://localhost:4000/api/v1/contacts/${application_id}`, data, {
      withCredentials: true,
    })
    .catch((error) => {
      console.log(error);
...
const update = async (data) => {
  const result = await axios
    .put(`http://localhost:4000/api/v1/contacts/${app_id}`, data, {
      withCredentials: true,
    })
    .catch((error) => {
      console.log(error);
...
const deleteContact = async () => {
  ...
  const result = await axios
    .delete(`http://localhost:4000/api/v1/contacts/${id}`, {
      withCredentials: true,
    })
    .catch((error) => {
      console.log(error);
